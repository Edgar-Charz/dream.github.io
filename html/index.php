                  ...
                  <div class="col-lg-2 col-md-2 col-6 mb-6">
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        if ($totalStudents = mysqli_num_rows($totalStudentsQueryResults) > 0) {
                  ...
                  <div class="col-lg-2 col-md-2 col-6 mb-6">
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <h4>Parents</h4>
                        <?php
                        $totalParentsQuery = "SELECT *
                                                    FROM parents";
                        $totalParentsQueryResult = $conn->query($totalParentsQuery);
                        if ($totalParents = mysqli_num_rows($totalParentsQueryResult) > 0) {
                          echo '<h4 class="card-title mb-3">' . $totalParents . '</h4>';
                        } else {
                          echo '<h4 class="card-title mb-3"> 0 </h4>';
                        }
                        ?>
                  ...
                  <div class="col-lg-2 col-md-2 col-6 mb-6">
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <h4>Admins</h4>
                        <?php
                        $totalAdminsQuery = "SELECT *
                                                    FROM administrators";
                        $totalAdminsQueryResult = $conn->query($totalAdminsQuery);
                        if ($totalAdmins = mysqli_num_rows($totalAdminsQueryResult) > 0) {
                          echo '<h4 class="card-title mb-3">' . $totalAdmins . '</h4>';
                        } else {
                          echo '<h4 class="card-title mb-3"> 0 </h4>';
                        }
                        ?>
