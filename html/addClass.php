...
if(isset($_POST['addClass'])) {
  ...
  $class_id = $conn->real_escape_string($_POST['classId']);
  $class_name = $conn->real_escape_string($_POST['className']);
  $class_teacher = $conn->real_escape_string($_POST['classTeacher']);
  
  $classQuery = "INSERT INTO classes(classId, className, classTeacherId, createdDate, updatedDate) 
                    VALUES('$class_id', '$class_name', '$class_teacher', '$currentTime', '$currentTime')";
...
if(isset($_POST['addDepartment'])) {
  ...
  $department_id = $conn->real_escape_string($_POST['departmentId']);
  $department_name = $conn->real_escape_string($_POST['departmentName']);
  

$departmentQuery = "INSERT INTO departments (departmentid, departmentName, createdDate, updatedDate) 
                        VALUES('$department_id', '$department_name', '$currentTime', '$currentTime')";

  if($conn->query($departmentQuery) === TRUE) {
    echo "<script>
        document.addEventListener('DOMContentLoaded', function () {
         Swal.fire({
                    title: 'Success!!',
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y" style="width: 60%">
                ...
                <div class="col-xl">
                  <div class="card mb-6">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-body float-end">Dream School</small>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="addClass.php">
                        <div class="mb-6">
                          <label class="form-label" for="basic-default-fullname">Id</label>
                          <input type="text" class="form-control" id="classId" name="classId" placeholder="Class Id" required/>
                        </div>
                        <div class="mb-6">
                          <label class="form-label" for="basic-default-company">Class Name</label>
                          <input type="text" class="form-control" id="className" name="className" placeholder="Class Name" required/>
                        </div>
                        <div class="mb-6">
                          <label class="form-label" for="basic-default-email">Class Teacher</label>
                        ...
                        <button type="submit" class="btn btn-primary" name="addClass">Send</button>
                      </form>
                    </div>
                  </div>
                </div>
                <div class="col-xl">
                  <div class="card mb-6">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-muted float-end">Dream School</small>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="addClass.php">
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                          <label class="form-label" for="basic-icon-default-company">Department Name</label>
                          <div class="input-group input-group-merge">
                        ...
                        <div class="mb-6">
                          <label class="form-label" for="basic-icon-default-email">Head Of Department</label>
                          <div class="input-group input-group-merge">
                        ...
                        <button type="submit" class="btn btn-primary" name="addDepartment">Send</button>
                      </form>
                    </div>
                  </div>
                </div>
